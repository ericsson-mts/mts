...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "DisengageConfirm", isSet = false )
    public class DisengageConfirm implements IASN1PreparedElement {
	...
	private NonStandardParameter nonStandardData = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(DisengageConfirm.class);
