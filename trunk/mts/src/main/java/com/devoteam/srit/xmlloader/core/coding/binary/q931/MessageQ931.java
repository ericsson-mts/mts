...
public class MessageQ931 
{
	...
	public MessageQ931(Element root) throws Exception 
    {
        ...
        for (Element element : elementsInf) 
        {
            ...
            elem.parseFromXML(element, this.dictionary, elemInfo, true);
    ...
    public MessageQ931(Array data, String syntax) throws Exception 
    {
        ...
        this.elements = ElementAbstract.decodeTag1OctetElementsFromArray(data.subArray(header.getLength()), this.dictionary);
    }
    ...
    {
        StringBuilder messageToString = new StringBuilder();
        messageToString.append(toShortString());
        messageToString.append("\n");
