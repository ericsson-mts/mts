...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "AdmissionReject", isSet = false )
    public class AdmissionReject implements IASN1PreparedElement {
	...
	private AdmissionRejectReason rejectReason = null;
	...
	private NonStandardParameter nonStandardData = null;
        ...
        public AdmissionRejectReason getRejectReason () {
            return this.rejectReason;
        }

        

        public void setRejectReason (AdmissionRejectReason value) {
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(AdmissionReject.class);
