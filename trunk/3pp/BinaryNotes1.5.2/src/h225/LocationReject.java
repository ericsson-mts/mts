...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "LocationReject", isSet = false )
    public class LocationReject implements IASN1PreparedElement {
	...
	private LocationRejectReason rejectReason = null;
	...
	private NonStandardParameter nonStandardData = null;
        ...
        public LocationRejectReason getRejectReason () {
            return this.rejectReason;
        }

        

        public void setRejectReason (LocationRejectReason value) {
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(LocationReject.class);
