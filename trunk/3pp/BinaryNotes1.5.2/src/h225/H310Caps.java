...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "H310Caps", isSet = false )
    public class H310Caps implements IASN1PreparedElement {
	...
	private NonStandardParameter nonStandardData = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(H310Caps.class);
