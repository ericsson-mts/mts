...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "Alerting_UUIE", isSet = false )
    public class Alerting_UUIE implements IASN1PreparedElement {
	...
	private TransportAddress h245Address = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(Alerting_UUIE.class);
