...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "T120OnlyCaps", isSet = false )
    public class T120OnlyCaps implements IASN1PreparedElement {
	...
	private NonStandardParameter nonStandardData = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(T120OnlyCaps.class);
