...
public class ListenpointTransportInfosSctp implements Listenpoint.TransportInfos {

	private ChannelConfigSctp channelConfigSctp;
	
	public ListenpointTransportInfosSctp(){
		this.channelConfigSctp = new ChannelConfigSctp();
	}
	
	public ListenpointTransportInfosSctp( ChannelConfigSctp channelConfigSctp ){
	...
	public boolean equals(Object object) {
		if( !(object instanceof ListenpointTransportInfosSctp) ){
			return false;
		}
		ListenpointTransportInfosSctp listenpointTransportInfosSctp = (ListenpointTransportInfosSctp)object;
		if( !this.channelConfigSctp.equals(listenpointTransportInfosSctp.channelConfigSctp) ){
			return false;
		}
		return true;
	}
