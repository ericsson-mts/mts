...
/**
 * Binding class used by groovy scripts to manage the exchange of properties between the groovy
 * scripts and MTS. More precisely, the binding will look for variables
 * either from MTSBinding itself, from the groovy script or from MTS Runner:
 * <ul>
...
public class MTSBinding extends Binding {
	 ...
	 * prefixed by "groovy_" are set into the groovy script. other variables are set
	 * into MTS ParameterPool.
	 * 
	 */
