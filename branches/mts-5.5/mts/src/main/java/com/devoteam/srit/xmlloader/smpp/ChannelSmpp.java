...
public class ChannelSmpp extends Channel
{
    private ChannelTcp channel = null;

    // --- constructeur --- //
    public ChannelSmpp(String name, String aLocalHost, String aLocalPort, String aRemoteHost, String aRemotePort, String aProtocol) throws Exception {
    ...
    public ChannelSmpp(String name, Listenpoint listenpoint, Socket socket) throws Exception
    {
        super(
                name,
    ...
    public boolean sendMessage(Msg msg) throws Exception{
        ...
        channel.sendMessage((MsgSmpp) msg);
        return true;
    }
    ...
    {
        String str = "<name=" + getName() + ", remoteHost=" + getRemoteHost() +
                     ", remotePort=" + getRemotePort() + ", localHost=" +
                     getLocalHost() + ", localPort=" + getLocalPort() + ">";
        return str;
    }
