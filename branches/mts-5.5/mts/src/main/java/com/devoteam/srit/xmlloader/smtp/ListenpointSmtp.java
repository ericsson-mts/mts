 ...
 * @author gpasquiers
 */
public class ListenpointSmtp extends Listenpoint
{    
    /** Creates a new instance of Listenpoint */
    public ListenpointSmtp(Stack stack) throws Exception
    {
        super(stack);
    }
    
	/** Creates a Listenpoint specific from XML tree*/
	public ListenpointSmtp(Stack stack, Element root) throws Exception	
	{
		super(stack, root);
	}
