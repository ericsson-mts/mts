 ...
 * @author bbouvier
 */
public class ListenpointUcp extends Listenpoint
{    

    /** Creates a new instance of Listenpoint */
    public ListenpointUcp(Stack stack) throws Exception
    {
        super(stack);
    }

	/** Creates a Listenpoint specific from XML tree*/
	public ListenpointUcp(Stack stack, Element root) throws Exception	
	{
		super(stack, root);
	}
