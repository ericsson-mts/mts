/*
 * MsgSmtp heritage Msg.java
 * But it doesn't use the transactionID attribute of Msg
 * 
 * byte[] data : coté client --> not trim ==> assurer DATA content avec un chiffre au début
 * 				 coté server --> trim	  ==> assurer le msg toujours commencer avec 3 chiffres 
 */
