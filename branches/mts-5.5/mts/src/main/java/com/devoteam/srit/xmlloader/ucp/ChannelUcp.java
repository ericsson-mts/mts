...
public class ChannelUcp extends Channel
{
    private ChannelTcp channel = null;

    // --- constructeur --- //
    public ChannelUcp(String name, String aLocalHost, String aLocalPort, String aRemoteHost, String aRemotePort, String aProtocol) throws Exception {
    ...
    public ChannelUcp(String name, Listenpoint listenpoint, Socket socket) throws Exception
    {
        super(
                name,
    ...
    public boolean sendMessage(Msg msg) throws Exception{
        ...
        channel.sendMessage((MsgUcp) msg);
        return true;
    }
