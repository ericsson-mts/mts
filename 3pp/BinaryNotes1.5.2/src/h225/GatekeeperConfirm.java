...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "GatekeeperConfirm", isSet = false )
    public class GatekeeperConfirm implements IASN1PreparedElement {
	...
	private TransportAddress rasAddress = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(GatekeeperConfirm.class);
