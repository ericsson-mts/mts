...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "UnregistrationRequest", isSet = false )
    public class UnregistrationRequest implements IASN1PreparedElement {
...
@ASN1SequenceOf( name = "endpointAlias", isSetOf = false ) 
	...
	private EndpointIdentifier endpointIdentifier = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(UnregistrationRequest.class);
