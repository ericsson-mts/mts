...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "UnregistrationReject", isSet = false )
    public class UnregistrationReject implements IASN1PreparedElement {
	...
	private UnregRejectReason rejectReason = null;
	...
	private NonStandardParameter nonStandardData = null;
        ...
        public UnregRejectReason getRejectReason () {
            return this.rejectReason;
        }

        

        public void setRejectReason (UnregRejectReason value) {
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(UnregistrationReject.class);
