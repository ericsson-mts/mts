...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "CallProceeding_UUIE", isSet = false )
    public class CallProceeding_UUIE implements IASN1PreparedElement {
	...
	private TransportAddress h245Address = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(CallProceeding_UUIE.class);
