...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "TerminalInfo", isSet = false )
    public class TerminalInfo implements IASN1PreparedElement {
	...
	private NonStandardParameter nonStandardData = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(TerminalInfo.class);
