 ...
 * @author  gpasquiers
 */
public class JFrameTasks extends javax.swing.JFrame {

    
    static private JFrameTasks instance;
    
    static public JFrameTasks instance()
    {
        if(null == instance) instance = new JFrameTasks();
