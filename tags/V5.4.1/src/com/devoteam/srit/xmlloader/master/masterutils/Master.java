...
public class Master
{
    ...
    private String name;
    private LinkedList<TestData> testDatas;
    
    public Master(XMLDocument xmlDocument, URI path) throws Exception
    {
    ...
    public void preparse(Runner runner) throws Exception
    {
    ...
    {
        this.testDatas = new LinkedList<TestData>();
        ...
        for(Element test:tests)
        {
            ...
            testDatas.add(new TestData(test, this.xmlDocument.getXMLFile()));
        }
        ...
        {
            if(hashSet.contains(testData.attributeValue("name"))) throw new Exception("Test name should be unique (" + testData.attributeValue("name") + ").");
            else hashSet.add(testData.attributeValue("name"));
        }
    }
    ...
    public LinkedList<TestData> getTestDatas()
    {
