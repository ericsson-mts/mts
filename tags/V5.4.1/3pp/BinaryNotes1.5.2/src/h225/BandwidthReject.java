...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "BandwidthReject", isSet = false )
    public class BandwidthReject implements IASN1PreparedElement {
	...
	private BandRejectReason rejectReason = null;
                
  
        @ASN1Element ( name = "allowedBandWidth", isOptional =  false , hasTag =  false  , hasDefaultValue =  false  )
    
	private BandWidth allowedBandWidth = null;
	...
	private NonStandardParameter nonStandardData = null;
        ...
        public BandRejectReason getRejectReason () {
            return this.rejectReason;
        }

        

        public void setRejectReason (BandRejectReason value) {
            this.rejectReason = value;
        }
        
  
        
        public BandWidth getAllowedBandWidth () {
            return this.allowedBandWidth;
        }

        

        public void setAllowedBandWidth (BandWidth value) {
            this.allowedBandWidth = value;
        }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(BandwidthReject.class);
