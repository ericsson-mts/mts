...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "AdmissionConfirm", isSet = false )
    public class AdmissionConfirm implements IASN1PreparedElement {
	...
	private CallModel callModel = null;
        ...
        @ASN1Element ( name = "destCallSignalAddress", isOptional =  false , hasTag =  false  , hasDefaultValue =  false  )
  ...
  @ASN1Integer( name = "" )
    @ASN1ValueRangeConstraint ( 
        ...
        @ASN1Element ( name = "irrFrequency", isOptional =  true , hasTag =  false  , hasDefaultValue =  false  )
    
	private Integer irrFrequency = null;
	...
	private NonStandardParameter nonStandardData = null;
        ...
        public Integer getIrrFrequency () {
            return this.irrFrequency;
        }

        
        public boolean isIrrFrequencyPresent () {
            return this.irrFrequency != null;
        }
        

        public void setIrrFrequency (Integer value) {
            this.irrFrequency = value;
        }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(AdmissionConfirm.class);
