...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "H322Caps", isSet = false )
    public class H322Caps implements IASN1PreparedElement {
	...
	private NonStandardParameter nonStandardData = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(H322Caps.class);
