...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "UI_UUIE", isSet = false )
    public class UI_UUIE implements IASN1PreparedElement {
	...
	private ProtocolIdentifier protocolIdentifier = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(UI_UUIE.class);
